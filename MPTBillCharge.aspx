<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MPTBillCharge.aspx.cs" Inherits="MPOP_Dashboard_CMS.MPTBillCharge" %>
    ...
    <table class="nav-justified">
        <tr>
            <td>
                &nbsp;</td>
            <td>
                <asp:Label ID="Label6" runat="server" Text="MPT Bill Charge" Font-Bold="True" Font-Size="Large" Font-Underline="True" ForeColor="#3333FF"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
